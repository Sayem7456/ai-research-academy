...
export const metadata: Metadata = {
  title: 'Benchmarking — AI Research Academy',
  description: 'Learn experiment design, evaluation metrics, and result reporting for effective AI research benchmarking.',
};
